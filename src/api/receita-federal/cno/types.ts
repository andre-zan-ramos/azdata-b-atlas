...
export interface WorkFilters extends PaginationParams { cno?: string; ni_responsavel?: string; uf?: string; codigo_municipio?: string; situacao?: string; cnae?: string; cno_vinculado?: string }
...
export interface WorkSummary {
  ...
  situacao: string | null; data_situacao: string | null; tipo_logradouro: string | null;
...
export interface WorkDetail extends WorkSummary {
  codigo_pais: string | null; pais: string | null; data_inicio_obra: string | null;
